...
loadRemembered();refresh();setInterval(()=>{ if(current.nextEvent?.at) $('countdown').textContent=countdownText(current.nextEvent.at); },1000);setInterval(refresh,3000);
